...
Esta practica esta conformada por tres partes diferentes, dos circuitos combinacionales y uno
secuencial, cada uno de estos hecho para probar la capacidad de crear, diseñar e implementar
circuitos digitales utilizando del lenguaje de diseño SystemVerilog.

En esta practica se hicieron los ejercicios de la guia que proponian realizar trabajos para aprender
sobre diseno de circuitos digitales utilizando SystemVerilog para el diseño de estos circuitos digitales,
...
combinacional considerablemente mas complejo y finalmente un sistema secuencial basico.


### Parte 2
Esta hace uso de un ALU con operaciones completamente personalizadas, una ROM que de igual forma
